...
{
    internal class ModelViewPerspectiveProjectionMatrixDrawAutomaticUniform : DrawAutomaticUniform
    {
        public ModelViewPerspectiveProjectionMatrixDrawAutomaticUniform(Uniform uniform)
        {
