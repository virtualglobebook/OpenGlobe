...
namespace OpenGlobe.Core
{
    ...
    public class Matrix42Tests
    {
        ...
        public void DoubleToFloat()
        {
            ...
            Assert.AreEqual(1.0f, m.Column0Row0, 1e-7);
            Assert.AreEqual(2.0f, m.Column1Row0, 1e-7);
            Assert.AreEqual(3.0f, m.Column2Row0, 1e-7);
            Assert.AreEqual(4.0f, m.Column3Row0, 1e-7);
            Assert.AreEqual(5.0f, m.Column0Row1, 1e-7);
            Assert.AreEqual(6.0f, m.Column1Row1, 1e-7);
            Assert.AreEqual(7.0f, m.Column2Row1, 1e-7);
            Assert.AreEqual(8.0f, m.Column3Row1, 1e-7);
        }
